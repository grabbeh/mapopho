...
function transformPhotoForMap(photos, fn){
    locations = {};
    $ = cheerio.load('<div><a target="_blank"><img style="padding: 0; margin: 0; width: 300px;"/></a><div class="appearances" style="background: #222222; padding: 10px; color: white; position: absolute; z-index: 100; top: 25px; right: 32px; font-weight: bold; font-size: 20px;"></div></div>');
